...
def parse_args():
    argument_parser = argparse.ArgumentParser(description="Perform SINDy on Bryan's LBM data of two tandem oscillating cylinders for all VR and L/D cases, parametrically on VR for each L/D.")
